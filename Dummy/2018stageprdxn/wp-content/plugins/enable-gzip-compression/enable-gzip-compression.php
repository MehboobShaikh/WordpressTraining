...
class EnableGzipCompression {
	...
	public function print_settings_page() {
		...
		<div class="gzip-settings">
			...
			<h2><span class="dashicons dashicons-admin-users"></span> <?php _e('Actions'); ?></h2>		
			...
			<form style="display: inline">
				<input type="button" onClick="window.open('https://mokimoki.net/donate-gzip-compression.php');" value="<?php _e('Like this? Support by donating $10'); ?>"/>
			</form>			
			...
			<p><?php _e('This plugin is part of <a target="_blank" href="http://mokimoki.net/poor-mans-wordpress-seo/">Poor Man\'s WordPress SEO</a> tools - the absolutely free All-In-One solution to control SEO on your site.'); ?></p>
		</div>
		<?php
