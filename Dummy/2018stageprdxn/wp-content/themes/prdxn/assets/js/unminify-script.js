...
$('#applicant-resume').siblings('label').append('<span class="file-ext" >( PDF files only. )</span>');
    ...
    /**
      ...
      */
      var loadpost = function() {
        ...
        siteurl = siteurl.slice(0, siteurl.lastIndexOf('/'));
        $.ajax ({
          type: 'GET',
          ...
          if(!$loadposts[5]) {
            ...
            $content.append($loadposts);
             setTimeout(function () {$loadposts.fadeIn(1000);},200);          // objectiveBlockHeight();
           }
