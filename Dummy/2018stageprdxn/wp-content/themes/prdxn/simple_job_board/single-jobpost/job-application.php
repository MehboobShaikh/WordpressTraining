    ...
    <div class="row">
        <div class="col-md-12">
                    ...
                    if (substr($key, 0, 7) == 'jobapp_'):
                        ...
                        switch ($val['type']) {
                            ...
                            case 'date':
                                echo '<div class="form-group">'
                                . '<label for="' . $key . '">' . $label . $required_field_asterisk . '</label>'
                                . '<div><input type="type" name="' . $name . '" class="form-control sjb-datepicker ' . $required_class . '" id="' . $id . '" ' . $is_required . '></div>'
                                . '</div>';
                                break;
                            case 'radio':
                                if ($val['options'] != '') {
                            ...
                            case 'dropdown':
                                if ($val['options'] != '') {
                                    ...
                                    echo '</select></div></div>';
                                    echo '<div><input type="type" name="' . $name . '" class="form-control '. $required_class . '
                                    " id="' . $id . '_other" ' . $is_required . '>  </div>'; 
                                }
                                break;
                            case 'checkbox' :
                                if ($val['options'] != '') {
            ...
            $sjb_attach_resume = '<div class="form-group">'
                    . '<label for="applicant_resume">' . apply_filters('sjb_resume_label', __('Attach Resume', 'simple-job-board')) . '</label>'
                    . '<input type="file" name="applicant_resume" id="applicant-resume" class="sjb-attachment form-control" required >'
           ...
           <!-- <div class="g-recaptcha" data-sitekey="6LdrZjEUAAAAACCaK5bYhUO97S3_o9zKCQcznNAm"></div> -->
            <!-- <div class="g-recaptcha" data-sitekey="6Lc_YTEUAAAAAF6eW4m7s9jarEoadCN1hQBe9ykS"></div> -->
