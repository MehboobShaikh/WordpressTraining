        ...
        <?php if(have_rows('news_media_image') || have_rows('news_media_video')){
            ...
            while(have_rows('news_media_image')){ the_row();
                ...
                if(get_sub_field('media_image')){
                    ...
                    <div>
                        <img data-u="image" src="<?php echo $media_image['url']; ?>" />
                        <img data-u="thumb" src="<?php echo $media_image['url']; ?>" />
                    </div>
            ...
            while(have_rows('news_media_video')){ the_row();
                ...
                if(get_sub_field('media_video')){
                    ...
                    <div>
                      ...
                      <!-- Dummy Image for Video Content in Slider -->
                        <img data-u="thumb" src="<?php echo get_template_directory_uri().'/img/video_thumbnail.png'; ?>" />
                    </div>
